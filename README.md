...
Check the [releases](https://github.com/droboports/java7/releases) page. If there are no releases available, then you have to compile.

Please keep in mind that by downloading and installing this app you are agreeing to the [Oracle Binary Code License Agreement](http://www.oracle.com/technetwork/java/javase/terms/license/index.html).
...
```
git clone https://github.com/droboports/java7.git
cd java7
./build.sh
```
...
* java: http://www.oracle.com/technetwork/java/embedded/embedded-se/downloads/index.html
